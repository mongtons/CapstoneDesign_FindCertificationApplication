...
import hallym.capstone.findcertificateapplication.databinding.FragmentPassBinding
...
class PassFragment(title:String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentPassBinding.inflate(layoutInflater, container, false)
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                for(cert in snapshot.children) {
                    ...
                    binding.passRecycler.layoutManager=layoutmanager
                    binding.passRecycler.adapter=ExamDayAdapter(resultList)
                }
